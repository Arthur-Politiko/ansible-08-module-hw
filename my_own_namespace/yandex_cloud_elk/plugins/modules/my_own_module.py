...
author:
    - Arthur Politiko (@github.com:Arthur-Politiko/ansible-08-module-hw)
'''
...
def run_module():
    ...
    try:
        ...
        result['message'] = f'Failed to use open file function: {e}'
    ...
    try:
        ...
        module.fail_json(msg=f'Failed to write to file: {e}', **result)
